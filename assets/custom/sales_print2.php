	...
	if($show_hsn == '1')
	{
		...
		if($state_flag == '0'){
			...
			for($i=0;$i<$len;$i++){
				...
				$pdf->Cell(20,5,$temp,'R',0,C);
				$pdf->Cell(20,5,number_format((float)$tax_details['taxable'][$i], 2),'R',0,C);
				$pdf->Cell(20,5,number_format((float)$tax_details['cgst'][$i], 2),'R',0,C);
				$pdf->Cell(20,5,number_format((float)$tax_details['sgst'][$i], 2),'R',0,C);
				$pdf->Cell(35,5,number_format((float)$tax_details['total'][$i], 2),'',1,C);
			...
			$pdf->Cell(20,5,number_format((float)$tot_taxable, 2),'TBR',0,C);
			$pdf->Cell(20,5,number_format((float)$tot_cgst, 2),'TBR',0,C);
			$pdf->Cell(20,5,number_format((float)$tot_sgst, 2),'TBR',0,C);
			$pdf->Cell(35,5,number_format((float)$tot_total, 2),'TB',1,C);
		}
		else{
			$pdf->SetFont('Arial','B',7);
			$pdf->Cell(190,3,'',0,1,C);
			...
			for($i=0;$i<$len;$i++){
				...
				$pdf->Cell(25,5,number_format((float)$tax_details['taxable'][$i], 2),'R',0,C);
				$pdf->Cell(30,5,number_format((float)$tax_details['igst'][$i], 2),'R',0,C);
				$pdf->Cell(35,5,number_format((float)$tax_details['total'][$i], 2),'',1,C);
			...
			$pdf->Cell(25,5,number_format((float)$tot_taxable, 2),'TBR',0,C);
			$pdf->Cell(30,5,number_format((float)$tot_igst, 2),'TBR',0,C);
			$pdf->Cell(35,5,number_format((float)$tot_total, 2),'TB',1,C);
		}
