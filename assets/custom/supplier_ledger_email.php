...
$email_arr = trim($_REQUEST['sl_em_email']);
$email_arr = str_replace(" ","",$email_arr);

$email = explode(',', $email_arr);
$len = sizeof($email);
$cc = explode(',', $_REQUEST['sl_em_email_cc']);
$len_cc = sizeof($cc);
$bcc = explode(',', $_REQUEST['sl_em_email_bcc']);
$len_bcc = sizeof($bcc);

$subject = $_REQUEST['sl_em_subject'];
$message = $_REQUEST['sl_em_message'];
