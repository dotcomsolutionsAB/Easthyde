...
class PDF_AutoPrint extends PDF_JavaScript
{
	...
	function Header()
	{
		...
		$this->Cell(190,7,'Proforma Invoice',0,2,C);
...
$GLOBALS["pr_no"] = $pr_no;
$GLOBALS["dt"] = date('d-m-Y', strtotime($row['pr_date']));
...
$email_arr = trim($_REQUEST['pr_em_email']);
$email_arr = str_replace(" ","",$email_arr);

$email = explode(',', $email_arr);
$len = sizeof($email);
$cc = explode(',', $_REQUEST['pr_em_email_cc']);
$len_cc = sizeof($cc);
$bcc = explode(',', $_REQUEST['pr_em_email_bcc']);
$len_bcc = sizeof($bcc);

$subject = $_REQUEST['pr_em_subject'];
$message = $_REQUEST['pr_em_message'];
