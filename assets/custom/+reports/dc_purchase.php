...
$count = 1;
$sql = "SELECT * FROM purchase_invoice WHERE pi_date BETWEEN '2022-07-01' AND '2022-07-31' ORDER BY pi_no";
$query = $db->query($sql);
while($row = $query->fetch_assoc()){ 
	...
	$total += $addons['freight']['value'] + $addons['pf']['value'] + $cgst + $sgst + $igst + $addons['roundoff'] + $addons['tcs'];
	...
	?>
	    ...
	    <tr>
	      ...
	      <td style="text-align:center;"><?php echo $row['pi_date']; ?></td>
