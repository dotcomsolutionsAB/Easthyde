...
$sql = "SELECT * FROM sales_order WHERE so_no = 'AIC/SO-170/20-21'";
$query = $db->query($sql);
while($row = $query->fetch_assoc()){
	...
	$sql_add = "UPDATE sales_order SET `items` = '$items_json',`tax` = '$tax_json',`total` = '$tot_amount',`addons` = '$addons_json' WHERE `id` = '$id'";
