...
$sql_fetch = "SELECT * FROM suppliers";
...
while($row_fetch = $query_fetch->fetch_assoc())
{
 ...
 //    $new_opening_balance['year'][] = '2021-22';
 //    $new_opening_balance['balance'][] = $total;

 //    $new_opening_balance = json_encode($new_opening_balance);

	$opening_balance['year'][3] = '2023-24';
    $opening_balance['balance'][3] = $total;

    $opening_balance = json_encode($opening_balance);

	$sql_add = "UPDATE suppliers SET `new_opening_balance` = '$opening_balance' WHERE `id` = '$id'";
