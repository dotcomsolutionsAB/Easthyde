...
$sheet->setCellValue('A1', 'SN')
      ...
      ->setCellValue('L1', 'IGST')
      ->setCellValue('M1', 'Total (Incl. GST)');
...
if ($isAll) {
    ...
    $sql = "SELECT * FROM sales_invoice WHERE id IN $ids AND si_date BETWEEN '$dt_start' AND '$dt_end' AND series != 'SECONDARY' AND cancelled = 0";
}
...
// Format all totals to two decimal places for clarity
