...
while($row = $query->fetch_assoc()){
    ...
    $len = sizeof($sales_invoice['pi_no']);
        ...
        <ALLLEDGERENTRIES.LIST>
            ...
            for($i=0;$i<$len;$i++){
                $xmlString .= '<BILLALLOCATIONS.LIST>
                    <NAME>'.$purchase_invoice['pi_no'][$i].'</NAME>
                    <BILLTYPE>New Ref</BILLTYPE>
                    <TDSDEDUCTEEISSPECIALRATE>No</TDSDEDUCTEEISSPECIALRATE>
                    <AMOUNT>'.$purchase_invoice['amount'][$i].'</AMOUNT>
