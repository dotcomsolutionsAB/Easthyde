...
class PDF_AutoPrint extends PDF_JavaScript
{
	...
	function Header()
	{
		...
		$this->Cell(190,7,'Credit Note',0,2,C);
		...
		$this->Cell(25,5,'Credit Note No.',0,0,L);
		$temp = ':   '.$GLOBALS["cn_no"];
...
$sql = "SELECT * FROM credit_note WHERE `cn_no` = '$cn_no'";
$query = $db->query($sql);
...
$GLOBALS["cn_no"] = $cn_no;
$GLOBALS["dt"] = !empty($row['cn_date']) ? date('d-m-Y', strtotime($row['cn_date'])) : '';
