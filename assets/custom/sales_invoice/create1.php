<?php
    ...
    function createWhatsAppQueueEntry($client, $order_no, $invoice_date, $mobile,$tot_amount, $series, $log_user) {
        ...
        $template_name = 'shht_invoice'; // WhatsApp template name
        $language_code = 'en'; // Language code for WhatsApp template
    
        // Dynamic link for the button with the invoice number
        if($series=='PRIMARY')
    ...
    $link = "sales_secondary_print.php?id=$order_no&type=print";
        ...
        $template_data = [
            ...
            'components' => [
                [
                    ...
                    'parameters' => [
                        // Header
                        ['type' => 'text', 'text' => $client], // Client name
                        ['type' => 'text', 'text' => $log_user], // Placeholder for SO number
                        ['type' => 'text', 'text' => $tot_amount], // Placeholder for invoice value
                        ['type' => 'text', 'text' => $order_no], // Invoice number
                        ['type' => 'text', 'text' => $invoice_date] // Placeholder for additional info
                    ]
                ],
                [
                    'type' => 'button',
                    ...
                    'index' => 0,
                    'parameters' => [
                        ['type' => 'text', 'text' => $link] // Link to the invoice
                    ]
                ]
            ]
        ];
    
        // Queue data for wa_sales_queue table
        $queue_data = [
            'group_id' => "invoice_" . $order_no, // Unique group ID based on invoice number
        ...
        // Insert data into wa_sales_queue
