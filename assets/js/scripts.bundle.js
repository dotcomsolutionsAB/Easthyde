...
var KTLayout = function() {
    var body;
    var header, headerMenu, headerMenuOffcanvas;
    var asideMenu, asideMenuOffcanvas, asideToggler;
    var asideSecondary, asideSecondaryToggler;
    var scrollTop, pageStickyPortlet;
    ...
    var initHeader = function() {
        ...
        if (headerEl) {
            var tmp = KTUtil.attr(headerEl, 'data-ktheader-minimize-offset');
            if (tmp) options.offset.desktop = tmp;

            tmp = KTUtil.attr(headerEl, 'data-ktheader-minimize-mobile-offset');
            if (tmp) options.offset.mobile = tmp;
    ...
    var initAside = function() {
        ...
        // Ensure the menu is always expanded and fixed
        KTUtil.removeClass(body, 'kt-aside--minimize');
        KTUtil.removeClass(body, 'kt-aside--minimize-hover');
        KTUtil.addClass(body, 'kt-aside--expanded');
        KTUtil.addClass(body, 'kt-aside--fixed');
        ...
        if (KTUtil.attr(menu, 'data-ktmenu-scroll') === '1') {
            scroll = {
                ...
                height: function() {
                    ...
                    height -= (KTUtil.actualHeight('kt_aside_brand') || 0);
                    height -= (KTUtil.actualHeight('kt_aside_footer') || 0);
                    height -= (parseInt(KTUtil.css(menu, 'marginBottom')) + parseInt(KTUtil.css(menu, 'marginTop')));
    ...
    var initAsideToggler = function() {
        // Disabling the toggle functionality to keep the aside maximized
        return;
    };

    // Aside Secondary Initialization
    var initAsideSecondary = function() {
        if (!KTUtil.get('kt_aside_secondary')) return;
    ...
    var initScrolltop = function() {
        scrollTop = new KTScrolltop('kt_scrolltop', {
            offset: 300,
            speed: 600
        });
    };

    // Sticky Portlet Initialization
    var initPageStickyPortlet = function() {
        if (!KTUtil.get('kt_page_portlet')) return;

        pageStickyPortlet = new KTPortlet('kt_page_portlet', {
            sticky: {
                ...
                position: {
                    top: function() {
                        var pos = 0;
                        if (KTUtil.isInResponsiveRange('desktop')) {
                            pos += parseInt(KTUtil.css(KTUtil.get('kt_header'), 'height') || 0);
                            pos += parseInt(KTUtil.css(KTUtil.get('kt_subheader'), 'height') || 0);
                        } else {
                            pos += parseInt(KTUtil.css(KTUtil.get('kt_header_mobile'), 'height') || 0);
                        }
                        return pos;
                    }
                }
    ...
    return {
        ...
        initAside: function() {
            initAside();
            initAsideMenu();
            initAsideToggler(); // This is now effectively disabled to keep the menu maximized
            this.onAsideToggle(function() {
                if (pageStickyPortlet) {
                    pageStickyPortlet.updateSticky();
                }
                $('.kt-datatable').each(function() {
        ...
        onAsideToggle: function(handler) {
            if (asideToggler && asideToggler.element) {
...
// Ensure KTLayout is initialized after DOM is ready
KTUtil.ready(function() {
    if (typeof KTLayout !== 'undefined' && typeof KTLayout.init === 'function') {
        KTLayout.init();
    } else {
        console.error("KTLayout or KTLayout.init is not defined.");
    }
});
