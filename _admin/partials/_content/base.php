						...
						<div class="row align-items-center">
							<div class="col-xl-12 order-2 order-xl-1">
								<div class="row align-items-center">				
									...
									<div class="col-md-2 kt-margin-b-5-tablet-and-mobile">
									...
									<div class="col-md-2 kt-margin-b-5-tablet-and-mobile">
											<div class="kt-form__control">
												<select class="form-control bootstrap-select" id="kt_product_vendor">
												</select>
											</div>
									</div>
									<div class="col-md-2 kt-margin-b-5-tablet-and-mobile">
									...
									<div class="col-md-1 kt-margin-b-5-tablet-and-mobile">
										<div class="kt-form__control">
											<select class="form-control bootstrap-select" id="kt_product_stock">
