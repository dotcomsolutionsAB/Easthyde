...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
				...
				<div class="kt-portlet__body">
					<div class="kt-section kt-section--first">
						<div class="form-group row">
							...
							<div class="col-sm-3 ">
										...
										<label>Receipt Type</label>
											<select class="form-control bootstrap-select2" name= "sales_receipt1" id="sales_receipt1">
												<option></option>
								...
								<div>	
									<span class="form-text text-muted">Please select the Receipt Type..</span>
				                </div>
                            </div>
						...
						<div class="row">
							...
							<div class="col-md-2">
								<strong style="float:right" id="rc_amount_total"></strong>
							</div>
							<div class="col-md-4">
								<strong style="float:left" id="rc_amount_entered"></strong>
							</div>
						</div>
                        ...
                        <div class="form-group row" id="bank_details" style="margin-top: 2em; display: none;">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input name="rc_ins_date" id="rc_ins_date" class="form-control date-picker" type="text">
    ...
    $(document).ready(function() {
        ...
        if (clientName) {
          //  $("#rc_client").append(new Option(decodeURIComponent(clientName), clientName, true, true)).trigger('change');  // Populate client name
			$("#rc_client").empty().append($("<option/>").val(clientName).text(clientName)).val(clientName).trigger("select");
			var selectEvent = new Event('select2:select', { bubbles: true, cancelable: true });
			$('#rc_client')[0].dispatchEvent(selectEvent);
		}
		if (totalAmount) {
            $("#amount").val(totalAmount).trigger('change');  // Populate total amount
        }
						...
						<div class="row align-items-center">
							<div class="col-xl-8 invoice-2 invoice-xl-1">
								<div class="row align-items-center">
									...
									<div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
										<div class="kt-form__control">
											<select class="form-control bootstrap-select2" id="kt_sales_receipt">
												<option></option>
