									...
									<div class="form-group row">
										<div class="col-sm-3">
			                                <div class="form-group">
			                                    ...
			                                    <span class="product_discount">Please enter name of the client..</span>
			                                </div>
			                            </div>
			                            <div class="col-sm-3">
			                                <div class="form-group">
							...
							<div class="kt-form__section kt-form__section--first">
								...
								<div class="kt-wizard-v3__form">
											...
											<div class="form-group form-group-last row" id="kt_repeater_1">
												<div data-repeater-list="sales_invoice" id="sales_invoice_list" class="col-lg-12">
													<div data-repeater-item class="form-group row align-items-center" style="border-bottom: 1px dashed #5d78ff; padding-bottom:1rem; margin-bottom: 1rem;">
														...
														<div class="col-md-6">
   															 <textarea class="form-control" name="si_product_description" placeholder="Product Description" rows="4"></textarea>
														</div>
									...
									<div class="form-group row" style="margin-bottom: 2px;">
										...
										<div class="col-md-2">
											<div class="input-group">
									            <input type="text" class="form-control" name="si_round" style="text-align:right;" id="si_round">
											</div>
										</div>
									</div>
									<div class="form-group row" style="margin-bottom: 2px;">
					...
					<div class="row align-items-center">
						<div class="col-xl-8 order-2 order-xl-1">
							<div class="row align-items-center">				
								...
								<div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
										<div class="kt-form__control">
											<select class="form-control bootstrap-select" id="kt_ssales_invoice_status">
												<option></option>
...
<div class="modal fade" id="cancel_sales_invoice" tabindex="-1" role="dialog" aria-labelledby="cancelSalesInvoiceModal" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
