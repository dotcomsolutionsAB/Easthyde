...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <?php
        ...
        if($menu_access['sales_invoice']['create'] == '1' || $userlevel == "sadmin_df56fdg"){
						...
						<div class="kt-wizard-v3__content" data-ktwizard-type="step-content"
							...
							<div class="kt-form__section kt-form__section--first">
								<div class="kt-wizard-v3__form">
									...
									<input type="text" name="si_state" id="si_state" style="display:none">
									...
									<div class="form-group row">
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<select class="form-control kt-select2 client-select2"
														name="si_client" id="si_client">
														<option></option>
													</select>
												</div>
												<span class="product_discount">Please enter name of the
													client..</span>
										...
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<input name="sales_invoice_no" placeholder="Sales Invoice #"
														id="sales_invoice_no" class="form-control" type="text">
												</div>
												<span class="form-text text-muted">Please enter the sales
													Invoice#..</span>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<input placeholder="Sales Invoice Date" name="sales_invoice_date"
														id="sales_invoice_date" class="form-control date-picker"
														type="text" data-date-end-date="+3m"
														value="<?php echo date('d-m-Y', strtotime('today')); ?>">
												</div>
												<span class="form-text text-muted">Please enter the sales invoice
													date..</span>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<select class="form-control kt-select2 si_series-select2"
														name="si_series" id="si_series">
														<option value="PRIMARY">Primary</option>
														<option value="SECONDARY">Secondary</option>
													</select>
												</div>
												<span class="form-text text-muted">Please select the invoice
													series..</span>
											</div>
										</div>
									</div>
											...
											<div class="col-sm-3">
												<div class="form-group">
													<div class="custom-checkbox-inline">
														<input type="checkbox" id="export_bill" name="export_bill" 	class="custom-checkbox">
														<label for="export_bill" class="custom-label">Export Bill</label>
													</div>
													<span class="form-text text-muted">Check if this is an export Bill.</span>
												</div>
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-3">
											...
											<div class="kt-input-icon">
												<input type="text" class="form-control" id="shipping_add_1"
													name="shipping_add_1">
											</div>
										</div>
										<div class="col-lg-3">
											...
											<div class="kt-input-icon">
												<input type="text" class="form-control" id="shipping_add_2"
													name="shipping_add_2">
											</div>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-lg-3">
											<label>State:</label>
											<div class="kt-input-icon">
												<select type="text" class="form-control kt-select2 sales_add_3-select2"
							...
							<div class="kt-form__section kt-form__section--first">
								<div class="form-group row">
									<div class="col-lg-3">
										...
										<div class="kt-input-icon">
											<select type="text"
												class="form-control kt-select2 si_sales_order-select2 kt-select2-multiple"
												id="si_sales_order" name="si_sales_order[]">
											</select>
										</div>
									</div>
									<div class="col-lg-3">
										...
										<div class="kt-input-icon">
											<select type="text"
												class="form-control kt-select2 si_quotation-select2 kt-select2-multiple"
												id="si_quotation" name="si_quotation[]">
											</select>
										</div>
									</div>
									<div class="col-lg-3">
										...
										<div class="kt-input-icon">
											<select type="text"
												class="form-control kt-select2 si_proforma_invoice-select2 kt-select2-multiple"
												id="si_proforma_invoice" name="si_proforma_invoice[]">
											</select>
										</div>
									</div>
								</div>
								<div class="kt-wizard-v3__form">
									...
									<div class="form-group row">
										<div id="kt_repeater_si">
											<div class="form-group form-group-last row" id="kt_repeater_1">
												<div data-repeater-list="sales_invoice" id="sales_invoice_list"
													class="col-lg-12">
													<div data-repeater-item class="form-group row align-items-center"
														...
														<div class="col-md-1" style="margin-top:3px; text-align:center">
															<input type="text" class="form-control" name="si_sn"
																value="1"
														...
														<div class="col-md-5">
															<div class="kt-form__group--inline">
																<div class="kt-form__control">
																	<select
																		class="form-control kt-select2 si_product_name-select2"
																		name="si_product_name">
																	</select>
																</div>
															</div>
															<span class="product_stock" name="product_stock"></span>
														...
														<div class="col-md-6">
															<textarea class="form-control" name="si_product_description"
																id="si_product_description"
														...
														<!-- <div class="col-md-4">
															<textarea class="form-control kt_autosize_so"
																...
																name="si_product_add_description" rows='1'
																style="height:40px;"></textarea>
														</div> -->
														<div class="col-md-1" style="margin-top:3px">
															<div class="kt-form__group--inline">
																<div class="kt-form__control">
																	<select name="si_adjustment"
																		class="form-control kt-select2 si_adjustment-select2">
														...
														<div class="col-md-1" style="margin-top:3px">
															<div class="input-group">
																<input placeholder="Qty" name="si_qty"
																	class="form-control si_qty" type="text">
															</div>
														</div>
														<div class="col-md-1" style="margin-top:3px">
															<div class="kt-form__group--inline">
																<div class="kt-form__control">
																	<select name="si_unit"
																		class="form-control kt-select2 si_unit-select2">
																	</select>
																</div>
															</div>
														</div>
														<div class="col-md-1" style="margin-top:3px">
															<div class="input-group">
																<input placeholder="Price" name="si_rate"
																	class="form-control si_rate" type="text">
															</div>
														</div>
														<div class="col-md-1" style="margin-top:3px">
															<div class="input-group">
																<input placeholder="Discount" name="si_dsc"
																	class="form-control si_dsc" type="text">
															</div>
														</div>

														<div class="col-md-1" style="margin-top:3px">
															<div class="input-group">
																<input placeholder="HSN" name="si_hsn"
																	class="form-control si_hsn" type="text">
															</div>
														</div>
														<div class="col-md-1" style="margin-top:3px">
															<div class="kt-form__group--inline">
																<div class="kt-form__control">
																	<select name="si_tax"
																		class="form-control kt-select2 si_tax-select2">
																		<option></option>
														...
														<div class="col-md-1" style="margin-top:3px">
															<div class="input-group">
																<input type="text" class="form-control si_gross_pr"
																	name="si_gross_pr" style="background-color: #eee"
																	readonly>
															</div>
														</div>
														<div class="col-md-1" style="margin-top:3px">
															<div class="input-group">
																<input type="text" class="form-control si_tax_pr"
																	name="si_tax_pr" style="background-color: #eee"
																	readonly>
															</div>
														</div>
														...
														<div class="col-md-1" style="margin-top:3px">
															<div class="input-group">
																<input type="text" class="form-control si_total_pr"
																	name="si_total_pr" style="background-color: #eee"
																	readonly>
															</div>
														</div>
														<div class="col-md-1" style="margin-top:3px">
															<div class="kt-form__group--inline">
																<div class="kt-form__control">
																	<select name="si_display_make"
																		class="form-control kt-select2 si_display_make-select2">
																		<option></option>
														...
														<div class="col-md-1" style="margin-top:3px; text-align:center">
															<a href="javascript:;" data-repeater-delete=""
																class="btn-sm btn btn-label-danger btn-bold si_delete">
											...
											<div>
												<div class="col-lg-4">
													<a href="javascript:;" data-repeater-create="sales_invoice"
														id="si_btn_add" class="btn btn-bold btn-sm btn-label-brand">
									...
									<div class="form-group row" style="margin-bottom: 2px;">
										<div class="col-md-10">
											<div class="form-control" style="text-align:right; border: none;">Gross
												Total :</div>

										</div>
										<div class="col-md-2">
											<div class="input-group">
												<input type="text" class="form-control si_gross_final"
													name="si_gross_final"
									...
									<div class="form-group row" style="margin-bottom: 2px;">
										<div class="col-md-10">
											<div class="form-control" style="text-align:right; border: none;">Packaging
												& Forwarding :</div>

										</div>
										<div class="col-md-2">
											<div class="input-group">
												<input type="text" class="form-control" name="si_pf"
													style="text-align:right;" id="si_pf">
											</div>
										</div>
									</div>
									<input type="text" name="si_pf_cgst" id="si_pf_cgst" style="display: none">
									<input type="text" name="si_pf_sgst" id="si_pf_sgst" style="display: none">
									<input type="text" name="si_pf_igst" id="si_pf_igst" style="display: none">
									<div class="form-group row" style="margin-bottom: 2px;">
										<div class="col-md-10">
											<div class="form-control" style="text-align:right; border: none;">Freight :
											</div>

										</div>
										<div class="col-md-2">
											<div class="input-group">
												<input type="text" class="form-control" name="si_freight"
													style="text-align:right;" id="si_freight">
											</div>
										</div>
									</div>
									<input type="text" name="si_freight_cgst" id="si_freight_cgst"
										style="display: none">
									<input type="text" name="si_freight_sgst" id="si_freight_sgst"
										style="display: none">
									<input type="text" name="si_freight_igst" id="si_freight_igst"
										style="display: none">
									<div class="form-group row" style="margin-bottom: 2px;">
										<div class="col-md-10">
											<div class="form-control" style="text-align:right; border: none;">Total Tax
												:</div>

										</div>
										<div class="col-md-2">
											<div class="input-group">
												<input type="text" class="form-control si_tax_final" name="si_tax_final"
													style="background-color: #eee; text-align:right;" readonly>
											</div>
										</div>
									</div>
									<div class="form-group row" style="margin-bottom: 2px;">
										<div class="col-md-10">
											<div class="form-control" style="text-align:right; border: none;">Round Off
												:</div>
										</div>
										<div class="col-md-2">
											<div class="input-group">
												<input type="text" class="form-control" name="si_round"
													style="text-align:right;" id="si_round">
											</div>
										</div>
									</div>
									<div class="form-group row" style="margin-bottom: 2px;">
										<div class="col-md-10">
											<div class="form-control" style="text-align:right; border: none;">Grand
												Total :</div>

										</div>
										<div class="col-md-2">
											<div class="input-group">
												<input type="text" value = '' class="form-control si_total_final"
													name="si_total_final"
													style="background-color: #eee; text-align:right;" readonly>
											</div>
										</div>
									...
									<div class="form-group row">
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<input name="buyer_order_no" placeholder="Buyer's order #"
														id="buyer_order_no" class="form-control" type="text">
												</div>
												<span class="form-text text-muted">Please enter the buyer's order
													#..</span>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<input name="buyer_order_date" placeholder="Buyer's Order Date"
														id="buyer_order_date" class="form-control date-picker"
														type="text">
												</div>
												<span class="form-text text-muted">Please enter the buyer's order
													date..</span>
										...
										<div class="form-group">
											...
											<textarea class="form-control" name="notes" id="notes"
												placeholder="Enter Notes" rows="4"></textarea>
										</div>
										<span class="form-text text-muted">Please enter the buyer's  Notes </span>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<input name="terms_payment" placeholder="Mode/Terms of Payment"
														id="terms_payment" class="form-control" type="text">
												</div>
												<span class="form-text text-muted">Please enter the mode/terms of
													payment..</span>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<textarea class="form-control kt_autosize_terms_delivery"
														placeholder="Terms of Delivery" name="terms_delivery"
														id="terms_delivery" rows='1' style="height:40px;"></textarea>
												</div>
												<span class="form-text text-muted">Please enter the terms of
													delivery..</span>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
												...
												<span class="form-text text-muted">Please enter other
													reference(s)..</span>
											</div>
										</div>
									</div>
									...
									<div class="form-group row">
										<div class="col-sm-3">
											<div class="form-group">
												<label>Medium</label>
												<div class="kt-input-icon">
													<input name="despatch_medium" placeholder="Medium"
														id="despatch_medium" class="form-control" type="text">
												</div>
										...
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<input name="despatch_doc_no" placeholder="Document #"
														id="despatch_doc_no" class="form-control" type="text">
												</div>
										...
										<div class="col-sm-3">
											<div class="form-group">
												<label>Date</label>
												<div class="kt-input-icon">
													<input name="despatch_date" placeholder="Date" id="despatch_date"
										...
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="kt-input-icon">
													<input name="despatch_destination" placeholder="Destination"
														id="despatch_destination" class="form-control" type="text">
												</div>
							...
							<div class="kt-form__section kt-form__section--first">
								<div class="kt-wizard-v1__review">
									...
									<div class="kt-wizard-v3__review-item">
										...
										<div id="review_despatch_destination" class="kt-wizard-v3__review-content">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xl-12 order-2 order-xl-1">
							<div class="row align-items-center">
								...
								<div class="col-md-2 kt-margin-b-20-tablet-and-mobile">
									<div class="kt-form__control">
										<select class="form-control bootstrap-select" id="kt_si_series">
											<option></option>
											<option value="PRIMARY">PRIMARY</option>
											<option value="SECONDARY">Secondary</option>
										</select>
								...
								<div class="col-md-2 kt-margin-b-20-tablet-and-mobile">
									<div class="kt-form__control">
										<select class="form-control bootstrap-select" id="kt_sales_invoice_product">
											<option></option>
										</select>
									</div>
								</div>
								<div class="col-md-2 kt-margin-b-20-tablet-and-mobile">
									<div class="kt-form__control">
										<select class="form-control bootstrap-select" id="kt_sales_invoice_user">
											<option></option>
										</select>
									</div>
								</div>
								<div class="col-md-2 kt-margin-b-20-tablet-and-mobile">
									<div class="kt-form__control">
										<select class="form-control bootstrap-select" id="kt_sales_invoice_status">
											<option></option>
...
<div class="modal fade" id="toggle_sales_hsn" tabindex="-1" role="dialog" aria-labelledby="toggleHSNModal"
	aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button id="toggle_hsn_submit" type="button" class="btn btn-primary">Save</button>
			</div>
		</div>
	</div>
</div>
...
<!--begin::edit AWB Table Modal-->
<div class="modal fade" id="update_awb_sales" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Update AWB #</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				</button>
			</div>
			<div class="modal-body">
				<!--begin::Form-->
				<div class="kt-portlet__body">
					<input name="si_awb" id="si_awb" class="form-control" type="text">
				</div>
				<!--end::Form-->
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
				<button id="update_awb_submit" type="button" class="btn btn-primary">Save</button>
			</div>
		</div>
	</div>
</div>
<!--end::edit AWB Table Modal-->

<!--begin::View Assembly Modal-->
<div class="modal fade" id="view_assembly" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Assemblies</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				</button>
			</div>
			<div class="modal-body">
				<div class="kt-datatable" id="sales_invoice_assembly_datatable"></div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
			</div>
...
<!--end::View Assembly Modal-->


<!--begin::Delete Sales Invoice Modal-->
<div class="modal fade" id="delete_sales_invoice" tabindex="-1" role="dialog" aria-labelledby="deleteSalesInvoiceModal"
	aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
...
<!--begin::Cancel Sales Invoice Modal-->
<div class="modal fade" id="cancel_sales_invoice" tabindex="-1" role="dialog" aria-labelledby="cancelSalesInvoiceModal"
	aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="cancelSalesInvoiceModal">Cancel Sales Invoice</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				</button>
			</div>
			<div class="modal-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
				<button id="cancel_sales_invoice_submit" type="button" class="btn btn-primary">Delete</button>
			</div>
		</div>
	</div>
</div>
<!--end::Cancel Sales Invoice Modal-->

<!--begin::Print Sales Invoice Modal-->
<form class="kt-form kt-form--label-right" action="/assets/custom/sales_print.php" method="POST" target="_blank">
	<div class="modal fade" id="print_sales_invoice" tabindex="-1" role="dialog"
		aria-labelledby="printSalesInvoiceModal" aria-hidden="true">
		<div class="modal-dialog modal-xl" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="deleteSalesInvoiceModal">Print Sales Invoice</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					</button>
				</div>
				<div class="modal-body">
					<!--begin::Form-->
					<input name="id" id="id" class="form-control" style="display: none" type="text">
					<input name="type" id="type" value="print" class="form-control" style="display: none" type="text">
					...
					<div class="form-group row">
						<div class="col-sm-6">
							<div class="form-group">
								<label>Start</label>
								<div class="kt-input-icon">
									<!-- <input name="si_start" id="si_start" class="form-control" type="text"> -->
									<select name="si_start" id="si_start"
										class="form-control kt-select2 si_start-select2">
										<option value="0">All</option>
										<option value="1">Not Applicable</option>
										<option value="2">Original</option>
										<option value="3">Duplicate</option>
										<option value="4">Triplicate</option>
										<option value="5">Extra Copy</option>
									</select>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="kt-input-icon">
									<input name="si_copies" id="si_copies" class="form-control" type="text">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
					<button id="si_print" type="submit" class="btn btn-primary">Print</button>
				</div>
			</div>
		</div>
	</div>
...
<!--end::Print Sales Invoice Modal-->

<!--begin::Send Email Modal-->
<form class="kt-form kt-form--label-right" id="send_si_email">
	<div class="modal fade" id="kt_modal_si_email" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!--begin::Form-->
					<div class="kt-portlet__body">
						<input name="si_em_id" id="si_em_id" class="form-control" type="text" style="display:none">
						<div class="form-group row">
							<div class="col-sm-6">
								<div class="form-group">
									<label>Send To</label>
									<div class="kt-input-icon">
										<input name="si_em_email" id="si_em_email" placeholder="Email Address"
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>Subject</label>
									<div class="kt-input-icon">
										<input name="si_em_subject" id="si_em_subject" class="form-control" type="text">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label>CC</label>
									<div class="kt-input-icon">
										<input name="si_em_email_cc" id="si_em_email_cc" placeholder="Email Address"
											class="form-control" type="text">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label>BCC</label>
									<div class="kt-input-icon">
										<input name="si_em_email_bcc" id="si_em_email_bcc" placeholder="Email Address"
											class="form-control" type="text">
									</div>
								</div>
							</div>
						...
						<div class="form-group row">
							<div class="col-sm-12">
								<div class="form-group">
									<div class="kt-input-icon">
										<input name="si_em_message" id="si_em_message" class="summernote">
				...
				<div class="modal-footer">
					<button id="si_email_submit" type="submit" class="btn btn-primary">Send</button>
				</div>
			</div>
		</div>
	</div>
...
<form class="kt-form kt-form--label-right" id="send_sales_invoice_whatsapp">
	<div class="modal fade" id="kt_modal_sales_invoice_whatsapp" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<!--begin::Form-->
					<input name="si_no_whatsapp" id="si_no_whatsapp" style="display:none" class="form-control"
						type="text">
						...
						<div class="form-group row" style="margin-bottom: 0">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="kt-input-icon">
										<input name="si_whatsapp_number" id="si_whatsapp_number"
				...
				<div class="modal-footer">
					<button id="si_whatsapp_submit" type="submit" class="btn btn-primary">Send</button>
				</div>
			</div>
		</div>
	</div>
