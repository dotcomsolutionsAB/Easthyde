...
$updated_stock = $row_pr['updated_stock'];
$updated_price = $row_pr['updated_price'];
...
// Assemblies
    ...
    //     $assembled_stock += $row_tmp['quantity'];
    // }
    ...
    // while($row_tmp = $query_tmp->fetch_assoc()){
    //     $stock -= $row_tmp['quantity'];
    //     $disassembled_stock += $row_tmp['quantity'];
    // }
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
        <div class="kt-grid__item kt-app__toggle kt-app__content" >
                                ...
                                <div class="kt-widget__section">
                                    ...
                                    <span class="kt-widget__desc">
                                        <?php 
                                            ...
                                            {
                                        ?>
                                        <span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill">Updated Stock</span> 
                                        <?php
                                        ...
                                        <?php 
                                            ...
                                            {
                                        ?>
                                        <span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill">Updated Price</span> 
                                        <?php
                            ...
                            <div class="kt-widget__content">
                                <div class="kt-widget__stats kt-margin-r-20">
                                    ...
                                    <div class="kt-widget__details">
                                        ...
                                        <span class="kt-widget__value"><span>Rs. </span><?php echo number_format('%!i', $row_pr['cost']); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="kt-widget__stats">
                                    ...
                                    <div class="kt-widget__details">
                                        ...
                                        <span class="kt-widget__value"><span>Rs. </span><?php echo number_format('%!i', $row_pr['rate']); ?></span>
                                    </div>
                                </div>
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate-slower">
                        <div class="kt-portlet__body" style="padding: 1px;">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="#"><?php echo $assembled_stock; ?> <?php echo $row_pr['unit']; ?></a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        Assembled Stock
                                    </div>
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate-slower">
                        <div class="kt-portlet__body" style="padding: 1px;">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="#"><?php echo $disassembled_to; ?> <?php echo $row_pr['unit']; ?></a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        Disassembled From Composite Product
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--danger kt-iconbox--animate-slower">
                        <div class="kt-portlet__body" style="padding: 1px;">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="#"><?php echo $disassembled_stock; ?> <?php echo $row_pr['unit']; ?></a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        Disassembled Stock
                                    </div>
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--danger kt-iconbox--animate-slower">
                        <div class="kt-portlet__body" style="padding: 1px;">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="#"><?php echo $assembled_to; ?> <?php echo $row_pr['unit']; ?></a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        Assembled to Composite Product
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <?php if($_SESSION['userlevel'] == 'sadmin_df56fdg'){ ?>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded">
                                <table class="table table-striped table-bordered" style="text-align: center">
                                    ...
                                    <tr>
                                        <td><?php echo $year; ?></td>
                                        <td><?php echo $opening_stock.' '.$row_pr['unit']; ?></td>
                                        <td>
                                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-sm" data-toggle="modal" data-target="#kt_modal_update_product_opening_stock" onclick='updateProductOpeningStock("<?php echo $year;?>" , "<?php echo $opening_stock; ?>" , "<?php echo $product_id; ?>")' title="Edit">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        ...
                        <div class="col-md-offset-6 col-md-6">
                        <div class="kt-input-icon kt-input-icon--left">
                            <input type="text" class="form-control" placeholder="Search..." id="search_pd_credit_note">
                            <span class="kt-input-icon__icon kt-input-icon__icon--left">
                                <span><i class="la la-search"></i></span>
                            </span>
                        </div>
                ...
                <div class="kt-portlet__body">
                    <div class="kt-datatable" id="pd_credit_note"></div>
                </div>
            </div>
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        ...
                        <div class="col-md-offset-6 col-md-6">
                        <div class="kt-input-icon kt-input-icon--left">
                            <input type="text" class="form-control" placeholder="Search..." id="search_pd_debit_note">
                            <span class="kt-input-icon__icon kt-input-icon__icon--left">
                                <span><i class="la la-search"></i></span>
                            </span>
                        </div>
                ...
                <div class="kt-portlet__body">
                    <div class="kt-datatable" id="pd_debit_note"></div>
                </div>
            </div>
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head">
...
<form class="kt-form kt-form--label-right" id="update_product_opening_stock" autocomplete="off">
    <div class="modal fade" id="kt_modal_update_product_opening_stock" tabindex="-1" role="dialog" aria-labelledby="addedit_member" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addedit_member" >Update Opening Stock</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Year</label>
                                    <div class="kt-input-icon">
                                        <input name="update_opening_stock_year" placeholder="Year" id="update_opening_stock_year" class="form-control" type="text" readonly="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="kt-input-icon">
                                        <input name="update_opening_stock" placeholder="Stock Qty" id="update_opening_stock" class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button id="update_product_opening_stock_submit" type="submit" class="btn btn-primary">Save</button>
                </div>
            </div>
        </div>
    </div>
