				...
				<div class="kt-portlet__body">
					<div class="kt-notes">
						<div class="kt-notes__items">
							<?php 
								$sql_notes = "SELECT * FROM proforma WHERE pr_no = '$pr_no'";
								...
								<div class="kt-notes__content">
									<div class="kt-notes__section">
										...
										<div class="kt-notes__dropdown">
											<a href="javascript:;" data-toggle="modal" data-target="#kt_modal_d_pr_note" title="Delete" onclick="<?php echo 'removeNoteProforma(\''.$row_notes['pr_no'].'\',\''.$i.'\')'; ?>" class="btn btn-sm btn-icon-md btn-icon" data-toggle="dropdown">
...
<div class="modal fade" id="kt_modal_d_pr_note" tabindex="-1" role="dialog" aria-labelledby="deleteQnoteModal" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button id="delete_proforma_note_submit" type="button" class="btn btn-primary">Delete</button>
			</div>
		</div>
	</div>
</div>
