							...
							<table class="table table-striped table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td style="text-align: center;"><?php echo money_format('%!i', $result['debit'][$i]); ?></td>
										<td style="text-align: center;"><?php if($result['credit'][$i] != 0){ echo money_format('%!i', $result['credit'][$i]); } ?></td>
									</tr>
    								<?php
